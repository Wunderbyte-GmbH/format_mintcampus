        ...
        const init = function (cmid) {
            ...
            if(ispresent.length){
               ...
               Ajax.call([{
                   ...
                   $("div.float-end a").removeClass("btn-link").addClass("btn-primary").html(await Str.get_string('captionnext', 'format_mintcampus'));
                   $("div.float-start a").removeClass("btn-link").addClass("btn-primary").html(await Str.get_string('captionback', 'format_mintcampus'));
