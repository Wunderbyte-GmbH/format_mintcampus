...
/**
 * mintcampus format Course index main component.
 *
 * @module     format_mintcampus/local/content
 * @class      format_mintcampus/local/content
...
export default class Component extends BaseComponent {
    ...
    create(descriptor) {
        ...
        this.name = 'mintcampus_course_format';
