...
$string['confirmdeletemsg'] = "Bewertung wirklich löschen";
...
$string['ratingsuccessfullydeleted'] = 'Rating erfolgreich gelöscht.';
$string['confirmdeletecommentmsg'] = 'Kommmentar wirklich löschen?';
